...
public class ManageEmployee {
	...
	public static void main(String[] args) {
		...
		Integer empID1 = ME.addEmployee("Dhananjay", "kumar", 1000);// asssinged values from here
		Integer empID2 = ME.addEmployee("ankit", "kumar", 50000);// asssinged values from here
